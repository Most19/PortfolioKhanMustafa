...
<head>
    ...
    <link rel="stylesheet" href="../styles/serviceinfopro.css">
    <link rel="stylesheet" href="../styles/index.css">
    <title>PortFolio - Projet Service Info PRO</title>
</head>
<body>
    <header class="header"> 
        <h1><a href="index.html">Projet Service Info PRO</a></h1>
        <ul>
    ...
    <div class="content">
        ...
        <div class="info">
            <a href="https://serviceinfopro.fr/" target="_blank">
                <img src="../images/serviceinfopro.png">
            </a>
        </div>

        <div class="description">
            <h1>Description</h1>
            <p>Le projet ServiceInfoPRO a été réalisé lors de mon stage de première année.</p> 
            ...
            <div class="buttons">
                <a href="https://serviceinfopro.fr/" target="_blank">Visiter le site</a>
                <a href="#" download>Télécharger le Projet</a>
            </div>
        </div>
        ...
        <div class="competences">
            ...
            <?php
                ...
                $selectedCompetences = [0, 1, 2, 3, 4, 5];

...
<body>
    <header class="header"> 
        <h1><a href="index.html">Projet TePlan</a></h1>
        <ul>
    ...
    <div class="content">
        ...
        <div class="info">
            <a href="#">
                <img src="../images/teplan.png">
            </a>
        </div>

        <div class="description">
            <h1>Description</h1>
            <p>Le projet TePlan est un projet </p> 
            <p>L'objectif de ce projet était de développer un site web fonctionnel pour l'entreprise TePlan.</p>
